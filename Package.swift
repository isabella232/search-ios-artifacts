...
let package = Package(
    ...
    products: [
        .library(
            name: "MapboxSearch",
            targets: ["SearchDependencies", "MapboxSearch"]
        ),
        .library(
            name: "MapboxSearchUI",
    ...
    dependencies: [
        .package(name: "MapboxMobileEvents", url: "https://github.com/mapbox/mapbox-events-ios",
                 .branch("odnairy/dynamic_spm")),
        .package(name: "MapboxCommon", url: "git@github.com:mapbox/mapbox-common-ios.git", from: "9.0.2"),
    ],
    targets: [
        registry.mapboxSearchTarget(version: "1.0.0-beta.2",
                                    checksum: "55f593849bd5e0e4b226d273052027c352270444b8e0e5ead6231a0b9e906317"),
        registry.mapboxSearchUITarget(version: "1.0.0-beta.2",
                                      checksum: "5854ba4d0e9b5f9ddfe0401aab3ce0e11e4986422ae0d46765850107d0313b78"),
        Target.target(name: "SearchDependencies",
                      dependencies: ["MapboxMobileEvents", "MapboxCommon"])
    ],
...
extension SDKRegistry {
    func mapboxSearchTarget(version: String, checksum: String) -> Target {
        return binaryTarget(name: "MapboxSearch",
                            version: version,
                            path: "search-sdk",
                            filename: "MapboxSearch.xcframework.zip",
                            checksum: checksum)
    }
    func mapboxSearchUITarget(version: String, checksum: String) -> Target {
        return binaryTarget(name: "MapboxSearchUI",
                            version: version,
                            path: "search-ui-sdk",
                            filename: "MapboxSearchUI.xcframework.zip",
                            checksum: checksum)
    }
}
